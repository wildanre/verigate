  ...
  return (
    <div
      ...
      className={cn(
        ...
        'after:content-[""] after:absolute after:z-[5] after:top-1/2 after:left-1/2 after:block after:size-full after:[background:radial-gradient(ellipse_at_50%_75%,#4ade80_20%,transparent_75%)] after:[transform:translate3d(-50%,-50%,0)] after:mix-blend-overlay',
        className,
      )}
      {...props}
    >
      ...
      <motion.div
        className={cn(
          ...
          'dark:[background:linear-gradient(20deg,#4ade80,#a7f3d020_16.5%,#e6e9ef_33%,#a7f3d020_49.5%,#4ade80_66%,#4ade8060_85.5%,#a7f3d0_100%)_0_100%_/_100%_200%] [background:linear-gradient(20deg,#4ade80,#a7f3d040_16.5%,#e6e9ef_33%,#a7f3d040_49.5%,#4ade80_66%,#4ade8080_85.5%,#a7f3d0_100%)_0_100%_/_100%_200%]',
        )}
